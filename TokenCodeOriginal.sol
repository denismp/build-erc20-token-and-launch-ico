...
contract DenisTestToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DenisTestToken() {
        //balances[msg.sender] = 1000000000000000000000;             // Give the creator all initial tokens. This is set to 1000 for example.
        balances[msg.sender] = 1000;                                 // Give the creator all initial tokens. This is set to 1000 for example.
        ...
        name = "DenisTestToken";                                     // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DTTS";                                             // Set the symbol for display purposes (CHANGE THIS)
